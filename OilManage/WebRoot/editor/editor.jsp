...
<link rel="stylesheet" media="screen" type="text/css" href="./assets/css/processui.css" /> 
...
<body onload="initLight('');" id="body">
	...
	<div id="editor">
			...
			<div id="output" style="margin-top:550px;margin-left:115px;border:solid;width:900px;height:250px;">
