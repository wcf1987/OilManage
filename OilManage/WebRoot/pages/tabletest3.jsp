...
colModel:[
{name:'teacher_name',index:'teacher_name', width:200},//每一列的具体信息，index是索引名，当需要排序时，会传这个参数给后端
{name:'organization_name',index:'organization_name', width:200,align:"right"}
