...
%> 
	...
	<link rel="stylesheet" type="text/css" href="css/simulate_gas_solid.css"/>
  ...
  <body  id="body"  onload="initLight();">
	    	...
	    	<div class="container-fluid">
				<div class="row-fluid row-fluid2">
					...
					<div class="page-header">
						<h2>气固两相管网水力计算&nbsp;<small>管网模拟</small></h2>
					...
					<div id="hydraulic_tab" class="tab-container">
						...
						<div id="input_tab"><!-- 节点数据 -->					
							<%@ include file="simulate_gas_solid/input_tab.jsp" %>
			    		</div>
			    		<div id="run_tab"><!-- 节点数据 -->
							<%@ include file="simulate_gas_solid/run_tab.jsp" %>
			    		</div>
			    		<div id="output_tab"><!-- 节点数据 -->	
							<%@ include file="simulate_gas_solid/output_tab.jsp" %>
			    		</div>
					</div>	            			
	...
	<%@ include file="simulate_gas_solid/modal.jsp" %>
