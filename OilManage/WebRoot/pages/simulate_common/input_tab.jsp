...
<div style="background-color:#fff;padding:5px;border:2px solid;height:40px;">
	...
	<div style="float:left"><button style="font-size:12px;height:22px;margin-right:10px;margin-top:5px;" onclick="showDescartes()">笛卡尔建模</button></div>	
	<div style="float:left"><button style="font-size:12px;height:22px;margin-right:10px;margin-top:5px;" onclick="showMapModel()">地图建模</button></div>							
</div>
