	     	  ...
	     	  <h5 class="modal-title" style="font-weight:bold;font-family:幼圆">输入:</h5>
					...
					<table id="hisInputTable" class="table" >
						...
						<tbody>
							<tr id="hisInputTr">
								<td id="hisInputID"></td>
								<td id="hisInputName"></td>
								<td id="hisInputValue"></td>
								<td id="hisInputSymbol"></td>						
							</tr>									
						</tbody>
					</table>	
				</dd>		
				...
				<dd>
					<table id="hisOutputTable" class="table" >
						...
						<tbody>
							<tr id="hisOutputTr">
								<td id="hisOutputID"></td>
								<td id="hisOutputName"></td>
								<td id="hisOutputValue"></td>
								<td id="hisOutputSymbol"></td>						
							</tr>									
						</tbody>
					</table>	
				</dd>	
				...
				<dd>
					<table id="calcHistoryTable" class="table" >
						...
						<tbody>
							<tr id="historyTr">
								<td id="historyID"></td>
								<td id="historyAlgName"></td>
								<td id="historyValue"></td>
								<td id="historyStartTime"></td>	
								<td id="historyEndTime"></td>		
								<td><a href="javascript:void(0)"  style="color:#798991" onclick="viewHisInputOutput(this)">查看输入输出</a></td>			
							</tr>									
						</tbody>
					</table>	
				</dd>							
