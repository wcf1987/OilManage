...
#output-container ul li { border:1px solid;background-color:#ccc;float: left; width:50%; margin: 0; padding: 0; text-align: center; border-top: solid 1px; }
...
#output-container ul li.active { width: 50%; background: #fff; border: solid 1px; border-top: none; }
