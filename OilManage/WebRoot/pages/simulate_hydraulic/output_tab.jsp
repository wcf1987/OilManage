...
<div id="output-container">
 ...
 <ul>
	<li><a href="#output-table-tab0">节点参数</a></li>
...
#output-container ul li { border:1px solid;background-color:#ccc;float: left; width:16.66%; margin: 0; padding: 0; text-align: center; border-top: solid 1px; }
...
#output-container ul li.active { width: 16.66%; background: #fff; border: solid 1px; border-top: none; }
