...
<div id="output-container">
 ...
 <ul>
	...
	<li><a href="#output-table-tab5">集气站中央处理厂连接</a></li>
	<li><a href="#output-table-tab6">路径</a></li>
	<li><a href="#output-table-tab7">总费用</a></li>
	<li><a href="#output-table-tab8">阀组位置</a></li>
	<li><a href="#output-table-tab9">集气站位置</a></li>
	<li><a href="#output-table-tab10">中央处理厂位置</a></li>
	<li><a href="#output-table-tab11">撬装液化点位置</a></li>
...
#output-container ul li { border:1px solid;background-color:#ccc;float: left; width:8.33%; margin: 0; padding: 0; text-align: center; border-top: solid 1px; }
...
#output-container ul li.active { width: 8.33%; background: #fff; border: solid 1px; border-top: none; }
