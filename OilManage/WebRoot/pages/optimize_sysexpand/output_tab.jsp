...
<div id="output-container">
 <div class="panel-container">
  ...
  <div id="output-table-tab2">
  	<table id="output_sheet2" class="table table-striped table-bordered table-hover datatable" style="width:1230px" ></table>
	<div style="box-shadow:2px 2px 10px #333300;border-radius: 11px;width:1230px" >
 ...
 <ul>
	...
	<li><a href="#output-table-tab1">井阀组连接</a></li>
	<li><a href="#output-table-tab2">阀组位置</a></li>
 </ul>
</div>
...
#output-container ul li { border:1px solid;background-color:#ccc;float: left; width:33.33%; margin: 0; padding: 0; text-align: center; border-top: solid 1px; }
...
#output-container ul li.active { width: 33.33%; background: #fff; border: solid 1px; border-top: none; }
