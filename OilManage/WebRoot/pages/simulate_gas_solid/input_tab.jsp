...
<div id="input-container">
 ...
 <ul>
	...
	<li><a href="#input-table-tab1">节点参数</a></li>
	<li><a href="#input-table-tab2">管段参数</a></li>
	<li><a href="#input-table-tab3">离心压缩机参数</a></li>
	<li><a href="#input-table-tab4">往复式压缩机参数</a></li>
 </ul>
</div>
